...
def main(targets):
    ...
    if (("test" in targets) or (targets == "test")):
        ...
        calculator.infection_risk(t0["time"], t0["rm"], t0["n_occupants"], t0["activity"], t0["expiratory_activity"], paths + "/data/raw/rm.csv", "max")
        print()
        ...
        print("In " + t0["rm"] + " given " + str(t0["n_occupants"]) + " occupants " + t0["activity"] + " and " + t0["expiratory_activity"]
             + " for " + str(t0["time"]) + " hours: ")
        calculator.infection_risk(t0["time"], t0["rm"], t0["n_occupants"], t0["activity"], t0["expiratory_activity"], paths + "/data/raw/rm.csv", "min")
        print()
